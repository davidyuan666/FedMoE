...
def main():
    parser = argparse.ArgumentParser(description="RQ3 - Hierarchical aggregation (single-machine 3xRTX3060)")
    # Data
    ...
    print(f"[RQ3] Experts: {expert_specialties}")

    exp = RQ3Experiment(cfg)
    results = exp.run()

    print("\n[RQ3] Strategy comparison:")
    print(results.get("rq3_comparison", {}))
